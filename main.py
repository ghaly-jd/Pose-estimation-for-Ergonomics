...
class PostureDetector:
    def __init__(self):
        """Initialize the posture detector with MediaPipe pose estimation."""
    ...
    def analyze_posture(self, landmarks) -> Tuple[str, float, float]:
        ...
        # Calculate shoulder alignment (horizontal angle)
    ...
    def draw_posture_feedback(self, image, posture_state: str, 
        ...
        # Draw posture duration
        if posture_state != "Unknown":
            cv2.putText(image, f"Duration: {self.posture_duration:.1f}s", 
    ...
    def run_detector(self):
        """Run the real-time posture detector."""
        ...
        print("🎯 Posture Detector Started!")
        print("📋 Instructions:")
        ...
        while cap.isOpened():
            ...
            if results.pose_landmarks:
                ...
                if posture_state == self.posture_state:
                    self.posture_duration = current_time - self.last_posture_change
                else:
